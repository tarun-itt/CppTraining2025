...
public:
    ...
    std::shared_ptr<FileSystemComponent> getFileSystemComponent(const std::string &path) const;
...
private:
    ...
    std::shared_ptr<Directory> resolveParentDirectory(const std::string &path, std::string &outName) const;
};