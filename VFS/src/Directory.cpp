...
Directory::getChild(const std::string &name) const {
...
const std::vector<std::shared_ptr<FileSystemComponent>> &
Directory::getChildren() const {
  return children;
}

std::vector<std::shared_ptr<FileSystemComponent>>
Directory::findByName(const std::string &name) const {
...
std::vector<std::shared_ptr<FileSystemComponent>>
Directory::findBySize(std::size_t minSize, std::size_t maxSize) const {
  std::vector<std::shared_ptr<FileSystemComponent>> results;
...
std::vector<std::shared_ptr<FileSystemComponent>>
Directory::findByTimestamp(std::time_t start, std::time_t end) const {
  std::vector<std::shared_ptr<FileSystemComponent>> results;
