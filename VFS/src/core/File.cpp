...
File::File(const std::string &name, const std::string &content) : FileSystemNode(name), content(content) {}
...
std::vector<std::shared_ptr<FileSystemNode>> File::findByContent(const std::string &pattern) const {
